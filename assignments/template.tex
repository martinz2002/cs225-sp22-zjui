...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\COURSECODE~\HWTITLE}
\fancyhead[C]{}
...
\newcommand\question{\item \textsc{\textbf{Our Answer.}}\newline}
\renewcommand\part{\item}
\newcommand\makeMyTitle{\maketitle \input{../memberInfo.tex}}
