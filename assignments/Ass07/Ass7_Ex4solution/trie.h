...
private:
    ...
    bool contains1(trienode<T> *pt, AList<T> list, AList<T> *extlist);
    void contains2(trienode<T> *pt, AList<T> list, AList<T> outlist);
    void contains3(trienode<T> *pt, AList<T> list, AList<T> outlist);
