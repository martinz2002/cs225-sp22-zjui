...
{
    // first graph
    bpgraphtraversal<int> * mygraph0 = new bpgraphtraversal<int>;
    (*mygraph0).addedge(2,13);
    (*mygraph0).addedge(1,14);
    (*mygraph0).addedge(1,12);
    (*mygraph0).addedge(3,14);
    (*mygraph0).addedge(2,14);
    (*mygraph0).addvertex1(7);
    (*mygraph0).addedge(3,17);
    (*mygraph0).addedge(7,12);
    (*mygraph0).addedge(1,14);
    (*mygraph0).prettyprint();
    (*mygraph0).findmatch();
    (*mygraph0).prettyprintmatching();
    // second graph
    ...
    (*mygraph).addedge(38,27);
    (*mygraph).prettyprint();
    (*mygraph).findmatch();
    (*mygraph).prettyprintmatching();
    return 0;
}
