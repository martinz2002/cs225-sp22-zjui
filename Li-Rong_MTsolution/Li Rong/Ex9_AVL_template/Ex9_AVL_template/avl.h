...
/* If you decide to change the basic data structure of an AVL tree, you may also need to change the header file. Otherwise the only change is the added public function median. */
