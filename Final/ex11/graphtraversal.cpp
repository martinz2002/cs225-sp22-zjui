...
template<class T> void neighbour<T>::prettyprint(void)
{
    cout << secondvertex << " ; ";
    return;
}
...
template<class T> void elist<T>::prettyprint(void)
{
...
template<class T> deeptreenode<T>::deeptreenode(T node, int pos, int finish, int low, deeptreenode<T> *pt)
{
    nodelabel = node;
    dfspos = pos;
...
template<class T> int deeptreenode<T>::getlowest(void)
{
    return lowest;
}

template<class T> T * deeptreenode<T>::getchildren(void)
{
    return children;
}

template<class T> int deeptreenode<T>::getnumchildren(void)
{
    return numchildren;
}

template<class T> T * deeptreenode<T>::getcones(void)
{
    return cones;
}

template<class T> int deeptreenode<T>::getnumcones(void)
{
    return numcones;
}
...
template<class T> void deeptreenode<T>::setlowest(int low)
{
    lowest = low;
    return;
}

template<class T> void deeptreenode<T>::addchild(T child)
{
...
template<class T> void deeptreenode<T>::addcone(T cone)
{
    cones[numcones] = cone;
    ++numcones;
    return;
...
template<class T> void deepsearchtree<T>::setlowest(T node, int low)
{
    deeptreenode<T> * cursor = first;
    while (cursor != 0)
    {
...
template<class T> void deepsearchtree<T>::addchild(T node, T child)
{
    deeptreenode<T> * cursor = first;
    while (cursor != 0)
    {
...
template<class T> void deepsearchtree<T>::addcone(T node, T cone)
{
    deeptreenode<T> * cursor = first;
    while (cursor != 0)
    {
...
template<class T> deeptreenode<T> * deepsearchtree<T>::getnode(T node)
{
    deeptreenode<T> * cursor = first;
    while (cursor != 0)
    {
...
template<class T> int deepsearchtree<T>::getpos(T node)
{
    deeptreenode<T> * cursor = first;
    while (cursor != 0)
    {
...
template<class T> int deepsearchtree<T>::getlowest(T node)
{
    deeptreenode<T> * cursor = first;
    while (cursor != 0)
    {
...
template<class T> void graphtraversal<T>::_traverse_nontreeedge(T first, T second, int dfspos, deepsearchtree<T> * output)
{
...
template<class T> elist<T> * graphtraversal<T>::articulation(T root)
{
